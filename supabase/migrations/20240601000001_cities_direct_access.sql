-- سياسات أمان الصفوف لجدول المدن للسماح بالوصول المباشر للمشرفين
...
-- إضافة تعليق توضيحي
COMMENT ON TABLE cities IS 'جدول المدن مع سياسات أمان الصفوف التي تسمح للمشرفين بإضافة وتعديل وحذف المدن';
